...
def cross_individuals(
    ...
    ind1_len = len(ind1.layers)
    ind2_len = len(ind2.layers)
    crossover_point1 = np.random.randint(low=1, high=ind1_len)
    crossover_point2 = np.random.randint(low=1, high=ind2_len)

    #get two individuals here
